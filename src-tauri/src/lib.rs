...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            shortcut::toggle_multi_model_selection,
            shortcut::get_post_process_prompts,
            shortcut::get_review_model_options,
            shortcut::rerun_single_with_prompt,
            shortcut::rerun_multi_model_with_prompt,
            shortcut::change_multi_model_post_process_enabled_setting,
            shortcut::add_multi_model_post_process_item,
            shortcut::update_multi_model_post_process_item,
            shortcut::remove_multi_model_post_process_item,
            shortcut::change_post_process_intent_model_id_setting,
            shortcut::change_length_routing_enabled_setting,
            shortcut::change_length_routing_threshold_setting,
            shortcut::change_length_routing_short_model_setting,
            shortcut::change_length_routing_long_model_setting,
