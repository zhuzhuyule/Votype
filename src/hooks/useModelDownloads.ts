...
export const useModelDownloads = (
    ...
    const { onDownloadComplete, onExtractionComplete, onModelStateChange, onError } =
        options;
    ...
    >(new Map());
    const [downloadStats, setDownloadStats] = useState<Map<string, DownloadStats>>(
        new Map()
    );
    ...
    }, [onDownloadComplete, onExtractionComplete, onModelStateChange, onError, clearDownload]);
