...
export const SecondaryTranscriptFusion: React.FC<SecondaryTranscriptFusionProps> =
  React.memo(({ grouped = false }) => {
    ...
    const canSelectSecondaryModel =
      postProcessEnabled && fusionEnabled && onlineAsrEnabled;
      ...
      <>
        ...
        {onlineAsrEnabled ? (
          <SettingContainer
            ...
            description={t(
              "settings.postProcessing.fusion.secondaryModel.description",
            )}
            grouped={grouped}
